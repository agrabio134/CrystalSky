...
function getActiveDay(date) {
    ...
    // testDate =  date + " " + months[month] + " " + year; 
...
const addEventFunction = () => {
    $("#addEventFunction").empty();
let str = `
      
 
 <form method="post" action="${url}addEventPost" id="add-event-form" enctype="multipart/form-data" >
 <div class="add-event-input"><div class="today-date">
     <input type="text" name="date" class="event-date" value="${eventDate.innerHTML = date + " " + months[month] + " " + year}" hidden/>
 </div>
 ...
 <div class="add-event-input">
     <input type="text" placeholder="Event Title" name="title" class="event-name"  required/>
 </div>
 <div class="add-event-input">
     <input type="time" placeholder="Event Time" name="time"  required/>
 </div>

 <input type="file" id="upload-button" accept="image/*" name="media" class="event-image" required/>
 <label for="upload-button">
     <i class="fas fa-upload"></i> &nbsp; Choose A Photo
 </label>

 <div class="content">
     <textarea name="description" placeholder="Description..." class="event-description" required></textarea> 
 </div>
 </div>
