...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 05, 2023 at 01:43 PM
...
(4, 'Amil', 'Musa', 'Male', '09198119666', '12345678', 'amilmusa02@gmail.com', 'amilbans', '$2y$10$YzkzOWY1MmRmNDdmMTAwO.vmURzrJjoAn9ItpQnrSeltMOK2sZkWa', '4b', 'Filtration', 'Olongapo', 'Philippines', 2200, 'VIP', 'ACTIVE', '2023-04-05 11:37:59');
...
INSERT INTO `cms_announcements` (`id`, `credentials_id`, `category_id`, `label_id`, `title`, `description`, `media`, `is_archived`, `created_at`) VALUES
(1, NULL, 1, 1, 'New Product Launch', 'We are excited to announce the launch of our new product line, featuring cutting-edge technology and innovative design. Visit our website today to learn more and place your order!', 'https://example.com/product-launch.jpg', 0, '2023-04-05 01:14:21'),
(2, NULL, 2, 2, 'Upcoming Event', 'Join us for our annual industry conference, where you will have the opportunity to learn from experts in the field, network with peers, and discover new strategies for success. Register now to secure your spot!', 'flyer.pdf', 0, '2023-04-05 01:14:21'),
(3, NULL, 3, 3, 'Important Update', 'In response to recent developments, we have updated our privacy policy to better protect our customers\' personal information. Please take a moment to review the changes and contact us with any questions or concerns.', NULL, 0, '2023-04-05 01:14:21'),
(4, NULL, 1, 4, 'Limited Time Offer', 'For a limited time only, enjoy exclusive discounts on select products and services. Don\'t miss this opportunity to save big and improve your bottom line. Visit our website or contact us for more information.', 'banner.jpg', 0, '2023-04-05 01:14:21'),
(5, NULL, 2, 5, 'New Hire Announcement', 'We are thrilled to welcome our newest team member, Jane Smith, to the company. With years of experience in the industry and a passion for innovation, Jane will be a valuable asset to our team. Please join us in extending a warm welcome to Jane!', 'welcome-jane.jpg', 0, '2023-04-05 01:14:21');
...
INSERT INTO `cms_events` (`id`, `credentials_id`, `title`, `category_id`, `description`, `media`, `date`, `time`, `is_archived`, `created_at`) VALUES
(1, 3, 'Annual Conference', 2, 'Join us for our annual conference on the latest trends in technology', 'conference.jpg', '2023-08-12', '10:00:00', 0, '2023-04-05 01:14:21'),
(2, 4, 'Product Launch', 2, 'Be the first to know about our latest product launch', 'product_launch.mp4', '2023-05-18', '14:30:00', 0, '2023-04-05 01:14:21'),
(3, 3, 'Team Building Event', 2, 'Let\'s strengthen our teamwork and have fun at the same time!', 'team_building.png', '2023-06-30', '09:00:00', 0, '2023-04-05 01:14:21'),
(4, 5, 'Holiday Party', 1, 'Celebrate the holiday season with us!', 'holiday_party.jpg', '2023-12-22', '18:00:00', 0, '2023-04-05 01:14:21'),
(5, 2, 'Training Session', 2, 'Join our training session on effective communication skills', 'training_session.pdf', '2023-04-20', '11:00:00', 0, '2023-04-05 01:14:21');
...
(1, 101, 1, 1, '2023-04-04 19:40:53'),
(2, 102, 2, 1, '2023-04-04 19:41:11'),
(3, 103, 3, 2, '2023-04-04 19:41:18'),
(4, 104, 4, 2, '2023-04-04 19:41:26'),
(5, 105, 1, 1, '2023-04-05 01:14:21'),
(6, 106, 2, 1, '2023-04-05 01:14:21'),
(7, 107, 3, 1, '2023-04-05 01:14:21'),
(8, 108, 2, 1, '2023-04-05 01:14:21'),
(9, 109, 1, 1, '2023-04-05 01:14:21'),
(10, 110, 2, 1, '2023-04-05 01:14:21');
...
(4, 4, 4, 4, 4, '2023-04-29', '2023-04-30', 'PENDING', '2023-04-05 11:41:36');
