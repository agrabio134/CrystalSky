...
INSERT INTO `cms_about_us` (`id`, `credentials_id`, `title`, `description`, `contact_no`, `email`, `location`, `uploaded_at`) VALUES
(1, 1, 'About Us', 'We are a team of passionate professionals dedicated to delivering high-quality products and services to our clients. Our mission is to help businesses succeed by providing innovative solutions that meet their unique needs. With years of experience and a d', NULL, 'info@mycompany.com', 'New York, NY', '2023-04-05 01:14:21');
...
INSERT INTO `cms_amenities` (`id`, `category_id`, `icon`, `description`) VALUES
(1, 1, 'Toiletries', 'Shampoo, lotion, etc.'),
(2, 2, 'Personal care', 'Combs, shaving cream, razor, shower cap, hair dryer'),
(3, 3, 'Coffee Kit', 'Maker, coffee and creamer'),
(4, 4, 'Tissue box', 'A box of tissue'),
(5, 5, 'Bathrobes and slippers', 'A pair of bathrobes and slippers'),
(6, 6, 'Pool parties', 'brown'),
(7, 7, 'icon1', 'TV');
...
INSERT INTO `housekeeping_tasks` (`id`, `employee_id`, `room_id`, `task_description`, `status_id`, `task_time`) VALUES
(1, 9, 1, 'Light bulbs are broken.', 1, '2023-04-14 01:00:00'),
(2, 9, 2, 'Door are broken', 1, '2023-04-14 02:30:00'),
(3, 9, 3, 'Glass has crack.', 1, '2023-04-14 12:27:22'),
(4, 9, 4, 'The bed does not have any sheets.', 1, '2023-04-14 12:27:36'),
(5, 9, 5, 'N/A', 1, '2023-04-15 12:28:30'),
(6, 10, 6, 'Needs repaint', 2, '2023-04-15 12:29:24'),
(7, 10, 7, 'The lamps are out of battery', 2, '2023-04-16 12:30:06'),
(8, 10, 8, 'The sheets are worn', 2, '2023-04-15 12:30:06'),
(9, 10, 9, 'Needs fire extuingisher', 2, '2023-04-15 12:30:54'),
(10, 10, 10, 'N/A', 2, '2023-04-14 12:30:54');
...
INSERT INTO `pos_cart` (`id`, `order_id`, `product_id`, `dish_id`, `item_quantity`, `item_total`) VALUES
(1, 1, 1, 1, '1', 79),
(2, 2, 2, 2, '1', 75),
(3, 3, 3, 3, '1', 79);
...
INSERT INTO `pos_orders` (`id`, `invoice_id`, `employee_id`, `table_id`, `time`, `location`, `payment_mode`, `status`, `is_paid`, `grand_total`, `created_at`) VALUES
(1, 1, 1, 1, '10:32:34', 'room1', 'cash', 'active', 'y', 0, '2023-04-05 04:37:35'),
(2, 2, 2, 2, '10:32:34', 'room2', 'cash', 'active', 'y', 0, '2023-04-05 04:38:41'),
(3, 3, 3, 3, '10:32:34', 'room3', 'cash', 'archive', 'n', 0, '2023-04-05 04:48:49');
